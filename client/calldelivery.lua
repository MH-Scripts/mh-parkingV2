...
RegisterNetEvent('mh-parkingV2:client:CallVehicleDelivery', function(data)
    CallVehicleDelivery(data)
end)

RegisterNetEvent('mh-parkingV2:client:GetVehiclesMenu', function()
    GetVehicleMenu()
end)
...
if GetResourceState("qb-core") ~= 'missing' then
    RegisterNetEvent('qb-radialmenu:client:onRadialmenuOpen', function()
        ...
        menu = exports['qb-radialmenu']:AddOption({id = 'CallVehicleDelivery_menu', title = "Call Delivery", icon = "info", type = 'client', event = "mh-parkingV2:client:GetVehiclesMenu", shouldClose = true}, menu)
    end)
